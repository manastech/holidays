...
module Holidays::ModuleGenerator
  class << self
    def create_module_source(module_name, files, regions, month_strings, custom_methods)
      validate!(module_name, files, regions, month_strings, custom_methods)
      module_src =<<-EOM
# encoding: utf-8
module Holidays
...
def self.custom_methods
  {
    ...
    def validate!(module_name, files, regions, month_strings)
