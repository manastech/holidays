...
module Holidays::FunctionProcessor
  class << self
    ...
    def process_function(input, func_id, desired_func_args, func_modifier = nil)
      ...
      function = Holiday::Factory::Definition.custom_method_repository.find(func_id)
    ...
    def calculate(input, id, args, modifier)
      result = Holiday::Factory::Definition.proc_result_cache_repository.lookup(id, *args)
